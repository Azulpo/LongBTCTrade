...
"""
Script: momentum_trailing_stop_backtest.py

Description:
This script simulates a momentum-based BTC trading strategy using 1-minute historical data.
It enters long positions every 15 minutes when short-term (15-minute) momentum is negative.
Positions are exited when either:
  - The price drops 3% from the peak (trailing stop), or
  - The price drops 3% within a 5-minute window.

Key Features:
- Simulates real-world trading with entry and exit fees
- Tracks account balance, PnL, trade timing, and fee impact
- Calculates performance metrics:
    - Total return
    - Sharpe ratio
    - Max drawdown
- Compares strategy performance to a BTC buy-and-hold benchmark
- Visualizes strategy balance vs. BTC price

Usage:
This utility is useful for evaluating the effectiveness of simple momentum-based entry signals
paired with risk-managed exit conditions. It helps quantify the impact of trading frequency,
fees, and stop logic on long-only BTC strategies.
