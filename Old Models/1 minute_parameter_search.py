...
"""
Script: parameter_search_random.py

Description:
Performs a random parameter search for a BTC momentum-based trading strategy.
Tests 500 randomly sampled combinations of:
- Entry momentum threshold
- Stop-loss percentage
- Maximum hold time

Each backtest simulates trades based on those parameters, applies fees,
and records performance metrics including:
- Final balance
- Total return %
- Sharpe ratio
- Max drawdown %
...
The results are saved to a CSV for further analysis or model training.

Intended Use:
- Strategy optimization and tuning
- Exploratory research
- Dataset generation for modeling return prediction or parameter selection
"""
