...
"""
Script: download_binance_1min_btc.py

Description:
Downloads 1-minute historical BTC/USDT candlestick data from Binance over the past 180 days.
Handles pagination (Binance limit: 1000 candles per request), rate limiting, and data formatting.
Uses tqdm to show progress and saves the result to a clean CSV.

Features:
- Customizable symbol, interval, lookback duration
- Converts Binance timestamps to readable datetime
- Saves columns: Datetime, Open, High, Low, Close, Volume

Output:
- CSV file at: /Users/aaron/PycharmProjects/PythonProject1/Data/btc_1min_6mo.csv

Use this as a core data ingestion script for backtesting and research.
"""
