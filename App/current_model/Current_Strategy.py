...
"""
Script: btc_momentum_5day_hold_strategy.py

Description:
A long-only BTC trading strategy using daily data. The strategy enters a trade when
a 5-day forward return is in the top 10% of all historical future returns, based on
price and volume-derived features. Positions are held for exactly 5 days.

Key Features:
- Uses moving averages, rate of change, and volume surge as features
- Signals based on top 10% of future 5-day returns
- Trades executed with realistic entry/exit fees
- Backtest includes PnL tracking, Sharpe ratio, and visual trade plotting

Useful for:
- Exploring momentum-based signal timing
- Backtesting forward-looking threshold strategies
- Evaluating signal effectiveness based on real outcomes
"""

# -------- Load BTC Data --------
data_file = "/Data/btc_binance_1d.csv"
